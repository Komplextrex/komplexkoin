...
const string strMessageMagic = "komplexkoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // komplexkoin: 1 days
static const int64 nTargetSpacing = 120; // komplexkoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal komplexkoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "komplexkoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc5cbe33f8660ed241d7fe575601aad1a492b1ab4e638eb3f2fa037438ea13222");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Complexity makes simplicity.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1406075086; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1520910;

        if (fTestNet)
        {
            block.nTime    = 1406075086;
            block.nNonce   = 1520910;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x03dc09fdff663a3bb072152833a39a244758974169a593baf33711c7e853b357"));
